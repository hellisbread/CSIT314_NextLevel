...
urlpatterns = [
    ...
    #Reviewer URL
    path('reviewer/', reviewerController.biddedPaperPage, name='biddedPaper'),
    ...
    path('reviewer/review/<int:id>',reviewerController.reviewPage, name='reviewPaper'),
    path('reviewer/review/create/<int:id>',reviewerController.createReview, name='createReview'),
    path('reviewer/review/edit/<int:id>',reviewerController.editReview, name='editReview'),
    path('reviewer/review/delete/<int:id>',reviewerController.deleteReview, name='deleteReview'),
    path('reviewer/review/comments/<int:id>',reviewerController.commentPage, name='commentPage'),
    path('reviewer/review/comments/create/<int:id>',reviewerController.createComment, name='createComment'),
    path('reviewer/review/comments/edit',reviewerController.editComment, name='editComment'),
    path('reviewer/review/comments/delete/<int:id>/<int:comment_id>',reviewerController.deleteComment, name='deleteComment'),
