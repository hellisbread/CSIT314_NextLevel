...
urlpatterns = [
    ...
    path('reviewer/review/edit/<int:bid_id>/<int:id>',reviewController.editReview, name='editReview'),
    path('reviewer/review/delete/<int:bid_id>/<int:id>',reviewController.deleteReview, name='deleteReview'),
