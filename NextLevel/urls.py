...
urlpatterns = [
    ...
    path('reviewer/papers/review/comments/edit/<int:id>',reviewerController.editComment, name='editComment'),
    path('reviewer/papers/review/comments/delete/<int:id>',reviewerController.deleteComment, name='deleteComment'),
